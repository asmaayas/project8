...
function Login(){
  ...
  <input type="email" placeholder="Email"  onChange={(e)=>dispatch(emailORUsername(e.target.value))}/> <br></br>
  <input type="password" placeholder="Password" onChange={(e)=>dispatch(password(e.target.value))}/> <br></br>
  <input
           defaultValue="Signin"
             type="submit"
         
              style={{ paddingLeft: "2.5rem", paddingRight: "2.5rem", background: 'none', border:'1px solid #fff'}}
            /><br></br>
